...
clrscr();
	...
	beginning:
	cout<<"\t\t\t----------Heaven's Fast Food Centre-----------\n\n";
	...
	if(choice==1)
	 {
		cout<<"\n1) "<<pizza1<<" Rs.250"<<"\n";
		cout<<"2) "<<pizza2<<" Rs.500"<<"\n";
		cout<<"3) "<<pizza3<<" Rs.750"<<"\n";
		cout<<"4) "<<pizza4<<" Rs.900"<<"\n";
		...
		if(pchoice1>=1 && pchoice1<=4)
		 {
			...
			case 3: choice = 750*quantity;
			break;

			case 4: choice = 900*quantity;
			break;
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\n\nThank you For Ordering From Heaven's Fast Food Centre\n";
			 break;
			 case 2:
			 cout<<"\t\t--------Your Order---------\n";
